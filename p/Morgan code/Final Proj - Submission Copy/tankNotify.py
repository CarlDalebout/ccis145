...
class Notification( pygame.sprite.Sprite ):
    def __init__( self, screen, text = "yay", textSize = 24, duration = 1, position = (250, 250), color = clr_WHITE, speed = (0,-3) ):
        """
        ...
        while ( FreeSpawn == False ):
            overlapping_text = pygame.sprite.spritecollideany( self, TextSprites )
